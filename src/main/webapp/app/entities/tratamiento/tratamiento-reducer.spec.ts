...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRATAMIENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRATAMIENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRATAMIENTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRATAMIENTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRATAMIENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRATAMIENTO actions', async () => {
      const arg = 42666;
