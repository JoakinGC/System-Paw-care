...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './factores.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACTORES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FACTORES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FACTORES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FACTORES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FACTORES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FACTORES actions', async () => {
      const arg = 42666;
