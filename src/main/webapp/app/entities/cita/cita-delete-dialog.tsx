...
export const CitaDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/cita' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="veterinarySystemApp.cita.delete.question">
        <Translate contentKey="veterinarySystemApp.cita.delete.question" interpolate={{ id: citaEntity.id }}>
