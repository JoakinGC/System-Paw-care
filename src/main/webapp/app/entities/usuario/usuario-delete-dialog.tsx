...
export const UsuarioDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="veterinarySystemApp.usuario.delete.question">
        <Translate contentKey="veterinarySystemApp.usuario.delete.question" interpolate={{ id: usuarioEntity.id }}>
