...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './estetica.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTETICA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ESTETICA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ESTETICA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ESTETICA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ESTETICA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ESTETICA actions', async () => {
      const arg = 42666;
