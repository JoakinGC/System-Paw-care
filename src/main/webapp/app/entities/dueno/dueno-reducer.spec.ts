...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dueno.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DUENO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DUENO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DUENO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DUENO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DUENO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DUENO actions', async () => {
      const arg = 42666;
