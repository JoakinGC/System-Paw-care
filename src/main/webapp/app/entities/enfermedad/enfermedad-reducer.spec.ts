...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENFERMEDAD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENFERMEDAD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENFERMEDAD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENFERMEDAD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENFERMEDAD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENFERMEDAD actions', async () => {
      const arg = 42666;
