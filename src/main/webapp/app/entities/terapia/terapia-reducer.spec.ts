...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './terapia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERAPIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TERAPIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TERAPIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TERAPIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TERAPIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TERAPIA actions', async () => {
      const arg = 42666;
