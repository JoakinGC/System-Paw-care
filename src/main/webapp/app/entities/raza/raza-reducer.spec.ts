...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './raza.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAZA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAZA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAZA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAZA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAZA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAZA actions', async () => {
      const arg = 42666;
