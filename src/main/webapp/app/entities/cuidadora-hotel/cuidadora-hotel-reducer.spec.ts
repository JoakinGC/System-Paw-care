...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUIDADORAHOTEL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUIDADORAHOTEL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUIDADORAHOTEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUIDADORAHOTEL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUIDADORAHOTEL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUIDADORAHOTEL actions', async () => {
      const arg = 42666;
