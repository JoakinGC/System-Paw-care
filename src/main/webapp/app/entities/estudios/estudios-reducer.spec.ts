...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './estudios.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTUDIOS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ESTUDIOS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ESTUDIOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ESTUDIOS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ESTUDIOS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ESTUDIOS actions', async () => {
      const arg = 42666;
