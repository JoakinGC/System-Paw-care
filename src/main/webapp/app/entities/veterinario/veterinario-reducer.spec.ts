...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VETERINARIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VETERINARIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VETERINARIO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VETERINARIO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VETERINARIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VETERINARIO actions', async () => {
      const arg = 42666;
