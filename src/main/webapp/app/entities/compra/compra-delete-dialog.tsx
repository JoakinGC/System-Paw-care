...
export const CompraDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/compra' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="veterinarySystemApp.compra.delete.question">
        <Translate contentKey="veterinarySystemApp.compra.delete.question" interpolate={{ id: compraEntity.id }}>
