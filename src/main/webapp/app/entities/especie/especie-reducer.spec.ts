...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './especie.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESPECIE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ESPECIE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ESPECIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ESPECIE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ESPECIE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ESPECIE actions', async () => {
      const arg = 42666;
