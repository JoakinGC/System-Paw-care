...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DATELLECOMPRA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DATELLECOMPRA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DATELLECOMPRA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DATELLECOMPRA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DATELLECOMPRA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DATELLECOMPRA actions', async () => {
      const arg = 42666;
