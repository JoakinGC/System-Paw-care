...
export const HistorialDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/historial' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="veterinarySystemApp.historial.delete.question">
        <Translate contentKey="veterinarySystemApp.historial.delete.question" interpolate={{ id: historialEntity.id }}>
          Are you sure you want to delete this Historial?
        </Translate>
      </ModalBody>
      <ModalFooter>
