...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mascota.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MASCOTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MASCOTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MASCOTA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MASCOTA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MASCOTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MASCOTA actions', async () => {
      const arg = 42666;
