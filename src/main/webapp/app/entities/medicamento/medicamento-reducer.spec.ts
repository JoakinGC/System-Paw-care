...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICAMENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICAMENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICAMENTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MEDICAMENTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICAMENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICAMENTO actions', async () => {
      const arg = 42666;
