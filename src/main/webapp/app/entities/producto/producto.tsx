      ...
      <h2 id="producto-heading" data-cy="ProductoHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/producto/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="veterinarySystemApp.producto.home.createLabel">Create new Producto</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productoList && productoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="veterinarySystemApp.producto.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nombre')}>
                  <Translate contentKey="veterinarySystemApp.producto.nombre">Nombre</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nombre')} />
                </th>
                <th className="hand" onClick={sort('descripcion')}>
                  <Translate contentKey="veterinarySystemApp.producto.descripcion">Descripcion</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="veterinarySystemApp.producto.home.notFound">No Productos found</Translate>
            </div>
          )
        )}
      </div>
