...
export const ProductoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="veterinarySystemApp.producto.delete.question">
        <Translate contentKey="veterinarySystemApp.producto.delete.question" interpolate={{ id: productoEntity.id }}>
