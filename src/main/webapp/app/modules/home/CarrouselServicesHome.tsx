...
const CarouselServicesHome = () => {
  const [activeIndex, setActiveIndex] = useState(0); // Estado para rastrear el índice activo del carrusel

  const handlePrevSlide = () => {
    // Función para manejar el clic en la flecha de "Previous"
    const newIndex = (activeIndex - 1 + 3) % 3; // Calcula el nuevo índice restando 1
    setActiveIndex(newIndex); // Actualiza el estado con el nuevo índice
  };

  const handleNextSlide = () => {
    // Función para manejar el clic en la flecha de "Next"
    const newIndex = (activeIndex + 1) % 3; // Calcula el nuevo índice sumando 1
    setActiveIndex(newIndex); // Actualiza el estado con el nuevo índice
  };
  ...
  return (
    <div id="carouselExampleDark" className="carousel carousel-dark slide" data-bs-ride="carousel">
      ...
      <div className="carousel-inner">
        <div className={activeIndex === 0 ? "carousel-item active" : "carousel-item"} data-bs-interval="10000">
          <img src='../../../content/images/horses.jpg' width={'800'} height={'600'} className="d-block w-100" alt="First slide"/>
        ...
        <div className={activeIndex === 1 ? "carousel-item active" : "carousel-item"} data-bs-interval="2000">
          <img src='../../../content/images/cat.jpg' width={'800'} height={'600'} className="d-block w-100" alt="Second slide"/>
          <div className="carousel-caption d-none d-md-block">
        ...
        <div className={activeIndex === 2 ? "carousel-item active" : "carousel-item"}>
          <img src='../../../content/images/fish.jpg' width={'800'} height={'600'} className="d-block w-100" alt="Third slide"/>
          <div className="carousel-caption d-none d-md-block">
