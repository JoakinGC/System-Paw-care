...
describe('Producto e2e test', () => {
  ...
  const productoSample = { nombre: 2781.39 };
  ...
  describe('new Producto page', () => {
    ...
    it('should create an instance of Producto', () => {
      cy.get(`[data-cy="nombre"]`).type('14576.1');
      cy.get(`[data-cy="nombre"]`).should('have.value', '14576.1');

      cy.get(`[data-cy="descripcion"]`).type('voluntarily mouser and');
      cy.get(`[data-cy="descripcion"]`).should('have.value', 'voluntarily mouser and');
