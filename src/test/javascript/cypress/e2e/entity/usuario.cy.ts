...
describe('Usuario e2e test', () => {
        ...
        cy.authenticatedRequest({
          ...
          cy.intercept(
            ...
            },
            {
              statusCode: 200,
              headers: {
                link: '<http://localhost/api/usuarios?page=0&size=20>; rel="last",<http://localhost/api/usuarios?page=0&size=20>; rel="first"',
              },
              body: [usuario],
            },
  ...
  describe('new Usuario page', () => {
    ...
    it('should create an instance of Usuario', () => {
      cy.get(`[data-cy="nombreUsuario"]`).type('conscious heritage w');
      cy.get(`[data-cy="nombreUsuario"]`).should('have.value', 'conscious heritage w');

      cy.get(`[data-cy="rol"]`).type('viciously phew');
      cy.get(`[data-cy="rol"]`).should('have.value', 'viciously phew');
